...
bool RAODVExample::Configure(int argc, char **argv)
{
...
void RAODVExample::Report(std::ostream &)
{
}

void RAODVExample::CreateNodes()
{
...
void RAODVExample::CreateDevices()
{
...
void RAODVExample::InstallInternetStack()
{
    RAodvHelper raodv;
...
void RAODVExample::InstallApplications()
{
